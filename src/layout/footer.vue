<template>
      <footer class="footer">
      <p>
        <a class="social-icon btn dot" href="https://github.com/txabman42" target="_blank" rel="noopener" data-toggle="tooltip" data-original-title="Follow us">
      ...
      Copyright © 2020 Xabier Martinez</p>
    </footer>
</template>
<script>
export default {
